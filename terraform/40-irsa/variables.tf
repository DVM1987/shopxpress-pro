...
variable "data_classification" {
  description = "Data sensitivity. IRSA role hold permission cho cluster system component → confidential."
  type        = string
...
variable "backup_policy" {
  description = "Backup policy. IAM resource stateless, recreated từ TF code → none."
  type        = string
  default     = "none"
